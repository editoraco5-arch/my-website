...
export default function DeleteChapterButton({ chapterId, contentId }) {
    ...
    const handleDelete = () => {
        startTransition(async () => {
            try {
                await deleteChapter(chapterId, contentId);
                setShowModal(false);
            } catch (e) {
            ...
            {showModal && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
                    ...
                    >
                        ...
                        <h3 className="text-xl font-bold text-white">حذف الدرس</h3>
